...
const Checkout = () => {
  ...
  return (
    <div className="flex min-h-full flex-1 lg:px-8 py-96 mb-44">
                    ...
                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                      <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                        ...
                        <button
                          onClick={() => clear()}
                          type="button"
                          className="font-medium text-indigo-600 pt-3 hover:text-indigo-500">
                          Remove Items
                        </button>
                        <div className="mt-8"> 
                                  ...
                                  <div className="ml-4 flex flex-1 flex-col">
                                    <div>
                                      <div className="flex justify-between text-base font-medium text-gray-900">
                                        <h3>
                                          <a key={cartContent.name}>{cartContent.name}</a>
                                        </h3>
