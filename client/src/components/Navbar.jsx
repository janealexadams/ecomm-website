            ...
            <div className="relative flex h-24 items-center justify-evenly">
              ...
              <div className="hidden sm:ml-6 sm:block">
                <div className="flex space-x-4">
                  {Auth.loggedIn() ? (
                    <>
                      <button className='mr-3 sign-in hover:text-white text-gray-400' onClick={logout} href='/signin'>Sign Out</button>
                    </>
                  ) : (
                    <>
                      <Link className='mr-3 sign-in hover:text-white text-gray-400' to="/signin">Sign In</Link>
                      <Link className='sign-up hover:text-white text-gray-400' to="/signup">Sign Up</Link>
                    </>
                  )}
                </div>
              </div>
